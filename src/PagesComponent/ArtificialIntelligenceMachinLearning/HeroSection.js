          ...
          <div className="row" style={{ alignItems: "center" }}>
            <div className="col-lg-6 mt-5 text-start" data-aos="fade-up">
              <h1 className="hero-sec-header">
                Elevate your business with our cutting-edge AI/ML and IoT
                Services
              </h1>
              <p className="para-for-hero">
                From inception to integration, we actualize your AI & ML
                aspirations through comprehensive cloud development. Elevate
                your concepts as we seamlessly translate visions into
                cloud-powered reality.
              </p>
            </div>
