          ...
          <div className="row" style={{ alignItems: "center" }}>
            <div className="col-lg-6 mt-5 text-start" data-aos="fade-up">
              <h1 className="hero-sec-header">
                Precision Software Solutions: Building Your Future
              </h1>
              <p className="para-for-hero">
                Turning Imagination into Excellence: From Concept to Perfection,
                We Craft Your Digital Dreams with Meticulous QA & Testing. Let's
                Elevate Your Vision into a Seamless Reality.
              </p>
            </div>
            <div className="col-lg-6 text-start" data-aos="fade-up">
              <Image
                src={coustomeSoftware}
                alt="Image not found"
                className="img-fluid"
              />
            </div>
