     ...
     return (
        <>
            ...
            <section className='our-portfolio'>
                <div className='container'>
                    <h1 className='text-center mt-5 mb-5'>Our Portfolio</h1>

                    <div class="col-12 mb-5 mx-auto">
                        <div class="d-flex justify-content-center">
                            <ul class="nav nav-pills p-3" style={{ "background": "rgba(228, 236, 255, 0.5)" }}>
                                <li class="nav-item mx-2">
                                    <a class="text-black" href="#">All Project</a>
                                </li>
                                <li class="nav-item mx-2">
                                    <a class="text-black" href="#">Web Design</a>
                                </li>
                                <li class="nav-item mx-2">
                                    <a class="text-black" href="#">Logo Design</a>
                                </li>
                                <li class="nav-item mx-2">
                                    <a class="text-black" href="#">Mobile App</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className='row '>
                        <div className='col-sm-4 mb-5'>
                            <div className='container'>
                                <div class="card p-3" style={{ "background": " linear-gradient(180deg, #2A64F9 0%, #012E4D 100%)" }} >
                                    <div class="card-body">
                        ...
                        <div className='col-sm-4 mb-5'>
                            <div className='container'>
                                <div class="card  p-3" style={{ "background": " linear-gradient(180deg, #E83030 0%, rgba(116, 13, 13, 0.97) 100%)" }}>
                                    <div class="card-body">
